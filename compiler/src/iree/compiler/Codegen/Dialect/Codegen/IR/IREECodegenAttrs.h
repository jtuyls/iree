...
static constexpr StringLiteral kUKernelDescriptorName = "iree_codegen.ukernel";
static constexpr StringLiteral kUKernelProviderName =
    "iree_codegen.ukernel_provider";
