...
//  CHECK-ALL-DAG:   %[[C100:.+]] = arith.constant 100 : index
//  CHECK-ALL-DAG:   %[[C500:.+]] = arith.constant 500 : index
//  CHECK-ALL-DAG:   %[[C250:.+]] = arith.constant 250 : index
//      CHECK-ALL:   %[[LHS:.+]] = iree_encoding.set_encoding %[[ARG0]] encoding_dims{%[[C100]], %[[C500]], %[[C250]]}
// CHECK-ALL-SAME:       tensor<100x250xf32, #[[LHS_ENCODING]]>
//      CHECK-ALL:   %[[RHS:.+]] = iree_encoding.set_encoding %[[ARG1]] encoding_dims{%[[C100]], %[[C500]], %[[C250]]}
// CHECK-ALL-SAME:       tensor<250x500xf32, #[[RHS_ENCODING]]>
//      CHECK-ALL:   %[[OUTS:.+]] = iree_encoding.set_encoding %[[ARG2]] encoding_dims{%[[C100]], %[[C500]], %[[C250]]}
...
//      CHECK-ALL:   %[[RESULT:.+]] = iree_encoding.unset_encoding %[[MATMUL]] encoding_dims{%[[C100]], %[[C500]], %[[C250]]} : tensor<100x500xf32, #[[OUT_ENCODING]]> -> tensor<100x500xf32>
...
// CHECK-ALL-SAME:       ins(%[[LHS]], %[[RHS]] :
// CHECK-ALL-SAME:       outs(%[[OUTS]] :
//      CHECK-ALL:   %[[RESULT:.+]] = iree_encoding.unset_encoding %[[MATMUL]] encoding_dims
...
// CHECK-SAME:       ins(%[[LHS]], %[[RHS]] :
// CHECK-SAME:       outs(%[[OUTS]] :
//      CHECK:   %[[RESULT:.+]] = iree_encoding.unset_encoding %[[BATCH_MATMUL]] encoding_dims
...
// CHECK-SAME:       ins(%[[LHS]], %[[RHS]] :
// CHECK-SAME:       outs(%[[OUTS]] :
//      CHECK:   %[[RESULT:.+]] = iree_encoding.unset_encoding %[[MATMUL]] encoding_dims
